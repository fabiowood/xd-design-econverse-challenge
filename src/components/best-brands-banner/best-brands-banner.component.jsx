...
const BestBrandsBanner = () => {  
  return (
    <section className='brands-display-container'>
      <article className='brands-display-title-container'>
        <h3 className='brands-display-title'>As <span className='brands-display-highlight-text'>Melhores</span> Marcas</h3>
      ...
      <article className='brands-logos-display-container'>
